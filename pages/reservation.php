...
<main class="min-h-screen bg-black text-white">
        ...
        <div class="carousel h-full w-full">
            <div class="carousel-inner h-full">
                ...
                <div class="carousel-item h-full w-full">
                    <img src="../assets/images/reservasi.jpg" class="h-full w-full object-cover" alt="Chef's Special">
                </div>
                <div class="carousel-item h-full w-full">
                    <img src="../assets/images/reservasi.jpg" class="h-full w-full object-cover" alt="Wine Selection">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4 max-w-7xl mx-auto">
        <h2 class="text-3xl font-serif font-bold mb-4 text-gold" data-aos="fade-up">Our Dishes</h2>
        ...
        <div class="grid md:grid-cols-3 gap-12">
                ...
                <form id="reservation-form" method="POST">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="date" name="date" readonly placeholder="Click to select date" class="w-full bg-black border border-gold py-3 px-4 focus:outline-none focus:ring-gold focus:border-gold text-gold cursor-pointer" required>
                        ...
                        <div id="pickup-details" class="mt-4 hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="pickup-time" name="pickup-time" class="w-full bg-black border border-gold py-3 px-4 focus:outline-none focus:ring-gold focus:border-gold text-white">
                                        <?php
                    ...
                    <input type="hidden" name="pickup_cost" id="pickup_cost_hidden" value="0">
                    <input type="hidden" name="food_cost" id="food_cost_hidden" value="0">
                    <input type="hidden" name="ordered_items" id="ordered_items_hidden" value="">
            ...
            <div class="border-2 border-gold p-8 h-fit sticky top-8 bg-gradient-to-b from-black to-gray-900 rounded-lg shadow-xl" data-aos="fade-left">
                ...
                <div id="ordered-items-section" class="mb-6 hidden">
                    ...
                    <div id="ordered-items-list" class="space-y-2 mb-4">
                        </div>
                </div>
                ...
                <div class="border-t-2 border-gold pt-4 space-y-2">
                    ...
                    <div id="food-cost-row" class="flex justify-between hidden">
                        ...
                        <span id="food-cost-summary" class="text-gold">$0.00</span>
                    </div>
...
<script>
    ...
    function updatePickupCost() {
        ...
        if (document.getElementById('pickup-yes').checked) {
            ...
            pickupCostSummary.textContent = `$${pickupCost.toFixed(2)}`;
            pickupCostRow.style.display = 'flex';
        } else {
            pickupCostElem.textContent = '$0';
            pickupCostSummary.textContent = '$0.00';
            pickupCostRow.style.display = 'none';
        }

        document.getElementById('pickup_cost_hidden').value = pickupCost;
        updateTotal();
    }
    ...
    function updateTotal() {
        ...
        const foodCostSummary = document.getElementById('food-cost-summary');
        if (foodCost > 0) {
            foodCostRow.style.display = 'flex';
            foodCostSummary.textContent = `$${foodCost.toFixed(2)}`;
            subtotal += foodCost;
        } else {
        ...
        const pickupCost = document.getElementById('pickup-yes').checked ?
            parseFloat(document.getElementById('pickup_cost_hidden').value) : 0;
        subtotal += pickupCost;
        ...
        document.getElementById('food_cost_hidden').value = foodCost;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createMenuItemHTML(item) {
            ...
            return `
                    <div class="border-2 border-gold hover:border-yellow-400 transition duration-300 transform hover:scale-105 bg-white rounded-lg shadow-lg overflow-hidden h-full flex flex-col">
                        ...
                        <div class="p-4 flex-grow flex flex-col">
                            ...
                            <p class="text-gray-600 text-sm mb-3 line-clamp-3 flex-grow">${item.description}</p>
        ...
        function updateOrderedItemsDisplay() {
            const orderedItemsContainer = document.getElementById('ordered-items-list');
        ...
        function updateSummary() {
            ...
            if (dateValue) {
                // Assuming date is in YYYY-MM-DD format from the hidden value
    ...
    document.getElementById('reservation-form').addEventListener('submit', function(e) {
        document.getElementById('pickup_cost_hidden').value = document.getElementById('pickup-yes').checked ? parseFloat(document.getElementById('pickup-cost').textContent.replace(/[^0-9.-]+/g, "")) : 0;
        document.getElementById('food_cost_hidden').value = orderedItems.reduce((total, item) => total + (item.price * item.quantity), 0);
        document.getElementById('ordered_items_hidden').value = JSON.stringify(orderedItems);
    });
...
<style>
    ...
    /* CSS untuk Grid Menu yang Rapi */
    #category-content {
        display: grid;
        /* Default 1 kolom untuk mobile, mencegah "blank space" */
    ...
    /* Media queries untuk responsive grid yang lebih terprediksi */
    ...
    /* 4 kolom untuk layar yang lebih besar (opsional, bisa dihapus jika tidak perlu) */
    ...
    /* Text clamp untuk deskripsi yang konsisten */
    .line-clamp-3 {
        display: -webkit-box;
        -webkit-line-clamp: 3;
    ...
    /* Memastikan gambar memiliki aspect ratio yang konsisten */
    .menu-item-image {
        aspect-ratio: 16/9;
        object-fit: cover;
    }
