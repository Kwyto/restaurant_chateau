            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="space-y-8">
                ...
                <div class="flex justify-end gap-4">
                    <button type="button" onclick="window.location.href='index.php'" 
                        class="px-6 py-3 border border-gray-800 text-white hover:border-gold hover:text-gold transition duration-300">
                        Cancel
                    </button>
                    <button type="submit" 
                        class="px-6 py-3 bg-gold text-black hover:bg-gold-dark transition duration-300">
                        Save Changes
                    </button>
                </div>
            </form>
