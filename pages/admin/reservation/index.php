                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500">
                                            <?= htmlspecialchars($reservation['guests']) ?> guests • <?= htmlspecialchars($reservation['ocassion']) ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button onclick="viewReservation(<?= $reservation['reservation_id'] ?>)" class="text-blue-600 hover:text-blue-900 mr-3">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button onclick="editReservation(<?= $reservation['reservation_id'] ?>)" class="text-green-600 hover:text-green-900 mr-3">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button onclick="deleteReservation(<?= $reservation['reservation_id'] ?>)" class="text-red-600 hover:text-red-900">
                ...
                .then(data => {
                    ...
                    details.innerHTML = `
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">${resData.reservation_number}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900">${resData.ocassion}</p>
                        </div>
                        <div>
